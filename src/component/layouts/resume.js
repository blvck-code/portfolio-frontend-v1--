        ...
        <div className="navbar">
          ...
          <div className="nav-menu">
            ...
            <ul className="nav-items">
              <a onClick={this.closeMenu} className="nav-item" href={`${myUrl}/#about`}>
                <li>
                  <span className="text-secondary">01.</span>About
                </li>
              </a>
              <a onClick={this.closeMenu} className="nav-item" href={`${myUrl}/#education`} onClick={this.navPage}>
                <li>
                  <span className="text-secondary">02.</span>Experience
                </li>
              </a>
              <a onClick={this.closeMenu} className="nav-item" href={`${myUrl}/#work`}>
                <li>
                  <span className="text-secondary">03.</span>Work
                </li>
              </a>
              <a onClick={this.closeMenu} className="nav-item" href={`${myUrl}/#contact`}>
                <li>
                  <span className="text-secondary">04.</span>Contact
                </li>
              </a>
              <Link onClick={this.closeMenu} className="nav-item" to="/resume">
                <li>
