                  ...
                  {projects.map((item) => (
                    ...
                    <div key={item.id} className="work-item">
                      ...
                      <div className="body">
                        ...
                        <div className="links">
                          {item.github ? <a href={item.github} rel="noopener noreferrer"  target="_blank"><i className="fa fa-github"></i></a>:<span>—</span>}
                          {item.link ? <a href={item.link} rel="noopener noreferrer"  target="_blank"><i className="fa fa-external-link"></i></a>:<span>—</span>}
                        </div>
                      </div>
                    </div> :""
                  ))}
